...
function PostMethodAgain() {
  ...
  const saveData = () => {
    axios
      .post("http://192.168.1.180:5001/takenaka/newUser", {
        name: data.name,
        takenaka_id: data.takenaka_id,
  ...
  return (
    <>
      ...
      <form>
        ...
        <input
          type="number"
          placeholder="Takanaka Id"
          id="takenaka_id"
          name="takenaka_id"
          value={data.takenaka_id}
          onChange={inputHandler}
        />
        <br />
        <br />
...
export default PostMethodAgain;
