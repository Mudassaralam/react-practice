...
function PostMethod(){
    ...
    const saveData = ()=>{
        fetch('http://192.168.1.180:5001/takenaka/newUser',{
            method:'POST',
            headers:{
    ...
    return(
        <>
            ...
            <form>
                ...
                <input type='text' placeholder='Takanaka Id' id='takenaka_id' name='takenaka_id' value={data.takenaka_id} onChange={inputHandler}/><br/><br/>
